...
//Public Directories
app.use('/static/css', express.static(path.join(__dirname, '../public/build/static/css')));
app.use('/static/js', express.static(path.join(__dirname, '../public/build/static/js')))
/* GET home page. */
router.get('/', (req, res)=>{
